...
import Largestar from "../../public/Rewards-images/big-star-modified.png";
          ...
          <div className={styles.r_card_content}>
            <div className={styles.r_card_contentsub}>
              <div className={styles.rContentleft}>
                <Image
                  src={Rlogo}
                  alt="Rewards Starbucks Logo"
                  className={styles.r_logo}
                />
      ...
      <div className={styles.r_tab}>
        ...
        <div className={styles.r_tab_content}>
          <div className={styles.r_tab_text}>
            ...
            <p>
              Create an account to get access to full range of Starbucks Rewards
              Benefits
            </p>
          </div>
          <div className={styles.r_tab_text}>
