  ...
  return (
    <div className={styles.aboutus_content}>
      ...
      <p style={{ marginBottom: "1.7rem" }}>
        We've always believed in buying and serving the best coffee possible.
        And it's our goal for all of our coffee to be grown under the highest
        standards of quality, using ethical trading and responsible growing
        practices. We think it's a better cup of coffee that also helps create a
        better future for farmers and a more stable climate for the planet.
      </p>
