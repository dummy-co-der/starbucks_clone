        ...
        <div className={style.filtercontent}>
          <div
            ...
            className={`${style.filterdata} ${
              currentselection === "bestseller" ? style.selected : ""
            }`}
          >
            <h4>BestSeller</h4>
          </div>
          <div
            onClick={() => setcurrentSelection("drinks")}
            className={`${style.filterdata} ${
              currentselection === "drinks" ? style.selected : ""
            }`}
          >
            <h4>Drinks</h4>
          </div>
          <div
            onClick={() => setcurrentSelection("foods")}
            className={`${style.filterdata} ${
              currentselection === "foods" ? style.selected : ""
            }`}
          >
            <h4>Foods</h4>
          </div>
          <div
            onClick={() => setcurrentSelection("merchandise")}
            className={`${style.filterdata} ${
              currentselection === "merchandise" ? style.selected : ""
            }`}
          >
            <h4>Merchandise</h4>
          </div>
          <div
            onClick={() => setcurrentSelection("coffee")}
            className={`${style.filterdata} ${
              currentselection === "coffee" ? style.selected : ""
            }`}
          >
            <h4>Coffee at Home</h4>
          </div>
          <div
            onClick={() => setcurrentSelection("ready")}
            className={`${style.filterdata} ${
              currentselection === "ready" ? style.selected : ""
            }`}
          >
            <h4>Ready To Eat</h4>
          </div>
