...
function Banner() {
  ...
  function Choose() {
    if (activeLink === "featured") return <Featured />;
    else if (activeLink === "anytime") return <Anytime />;
    else if (activeLink === "congratulations") return <Congratulations />;
    else if (activeLink === "thankyou") return <Thankyou />;
  }
  return (
      ...
      <div className={styles.g_content}>
        <div className={styles.g_card}>
          <Image
            src={Gbanner}
            alt="Gift's Banner"
            className={styles.g_card_background}
          />
          <div className={styles.g_card_content}>
            <p> Introducing </p>
            <h3> Savannah Animals Mug </h3>
            <p>
              Wander into the wilderness with every sip in this Savannah Animals
              Mug with giraffe head ornament on rim.
            </p>
            <p> For </p>
            <p> ₹ 2190 </p>
        ...
        <ul className={styles.g_tab_list}>
          <li className={styles.tab_item1}>
            <div
              ...
              className={`${styles.link} ${
                activeLink === "featured" ? styles.active : ""
              }`}
          ...
          <li className={styles.tab_item2}>
            <div
              title="Anytime"
              className={`${styles.link} ${
                activeLink === "anytime" ? styles.active : ""
              }`}
          ...
          <li className={styles.tab_item2}>
            <div
              ...
              className={`${styles.link} ${
                activeLink === "congratulations" ? styles.active : ""
              }`}
          ...
          <li className={styles.tab_item3}>
            <div
              title="ThankYou"
              className={`${styles.link} ${
                activeLink === "thankyou" ? styles.active : ""
              }`}
