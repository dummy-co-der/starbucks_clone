...
const Environment = () => {
  return (
    <div className={styles.aboutus_content}>
      ...
      <h3 className={styles.d_quote} style={{ marginTop: "0rem" }}>
        We share our customers' commitment to the environment
      </h3>
      <p style={{ marginBottom: "1.7rem" }}>
        And we believe in the importance of caring for our planet and working
        with and encouraging others to do the same. As a company that relies on
        an agricultural product, it makes good business sense. And as people
        living in the world, it is simply the right thing to do.
      </p>
